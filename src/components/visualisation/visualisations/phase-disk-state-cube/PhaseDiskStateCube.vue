...
} from "@/components/visualisation/visualisations/phase-disk-state-cube/phase-disk-state-cube-scene-manager";
...
function update() {
    ...
    if (
        ...
        if (quantumStates) sceneManager.value?.applyStates(quantumStates);
    }
}
